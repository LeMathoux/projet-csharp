...
namespace TheatreBO
{
    public class Pieces
    {
        ...
        public Compagnie CompagniePiece { get; set; } // Propriété pour stocker la compagnie de la pièce
        ...
        public Pieces(int idPiece, string nomPiece, string descPiece,string dureePiece, decimal tarifBase, Theme themePiece, Public publicPiece, Auteur nomAuteur, Compagnie compagnie)
        {
            IdPiece = idPiece;
